<%-- 
    Document   : vehicle
    Created on : Apr 5, 2018, 11:52:36 AM
...
<html data-locale="fr_FR" lang="fr">
    ...
    <body style="background-color:gray;">
        ...
        <br><br><br><br>
        <div >
            <h1 align="center">Votre voiture</h1>



            <form style="margin-left: 20%" name="vehicle" method="post">
                <fieldset id="step_license_plate" data-view-name="add_vehicle_license_plates" data-has-result="false" aria-hidden="false" data-step-status="invalid" data-step-index="1">

                    <div>
                        <p>Quel est votre numéro de plaque&nbsp;?<span>Nous ne le donnerons qu'aux passagers ayant réservé avec vous.</span>
                        </p>
                    </div>
                    ...
                    <div>
                        <p >Est-ce que ces informations sont correctes ? </p>
                    </div>
                    ...
                    <div >
                        <button type="button">Oui, tout est bon</button>
                        <button type="button">Non, pas tout à fait</button>
                        <p><small>Votre plaque d'immatriculation a permis à Comuto SA d'interroger le fichier détenu par la société DataNeo afin d'identifier les caractéristiques principales de votre véhicule et vous proposer des services adaptés. Vous disposez d'un droit d'accès, de rectification et d'opposition.</small></p>
                    </div>

                    <div style="position: relative;">

                        <div >
                            <p >Vous avez un véhicule de quelle marque ?</p>
                        </div>
                    </div>
                    <input id="vehicle_marque">

                    <div >
                        <p >Quel type de voiture est-ce ?</p>
                    </div>

                    <input id="vehicle_vehicle_type" name="vehicle_vehicle[type]" >

                    <div >
                        <p >Quelle couleur ?</p>
                    </div>

                    <input id="vehicle_vehicle_color" name="vehicle_vehicle[color]" >

                    <div >
                        <p >De quand date sa première immatriculation ?<span>Les passagers apprécient quand ils peuvent se faire une idée de l'âge de votre véhicule. </span>
                        </p>
                    </div>
                    ...
                    <div >
                        <div >
                            <div >
                                <input type="number" id="vehicle_vehicle_registration_year" name="vehicle_vehicle[registration_year]"   min="1950" max="2018" data-error-value=""  data-error-message="Saisissez une année valide.">

                                <label for="vehicle_vehicle_registration_year" >
                                    <span>Saisissez l'année (AAAA)</span>
                                </label>
                                <span ></span>
                            </div>
                        </div>
                    ...
                    <div >
                        <button type="submit" id="vehicle_vehicle_submit" name="vehicle_vehicle[submit]" >
                            Soumettre</button>
                    </div>
